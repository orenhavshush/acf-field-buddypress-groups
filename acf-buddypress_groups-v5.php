...
class acf_field_buddypress_groups extends acf_field {
	...
	*/
	...
	function __construct() {
		...
		*/
		...
		$this->label = __('Buddypress Groups', 'acf-buddypress_groups');
		...
		*  var message = acf._e('buddypress_groups', 'error');
		*/

		$this->l10n = array(
			'error'	=> __('Error! Please enter a higher value', 'acf-buddypress_groups'),
		);
	...
	*/
	...
	function render_field_settings( $field ) {
		...
		*/
		...
		// return_format
		acf_render_field_setting( $field, array(
			'label'			=> __('Return Format','acf-buddypress_groups'),
			'instructions'	=> '',
			'type'			=> 'radio',
			'name'			=> 'return_format',
			'choices'		=> array(
	...
	*/
	...
	function input_admin_enqueue_scripts() {
		...
		// register & include JS
		wp_register_script( 'acf-input-buddypress_groups', "{$dir}js/input.js" );
		wp_enqueue_script('acf-input-buddypress_groups');


		// register & include CSS
		wp_register_style( 'acf-input-buddypress_groups', "{$dir}css/input.css" );
		wp_enqueue_style('acf-input-buddypress_groups');
	...
	*/
	...
	function validate_value( $valid, $value, $field, $input ){
		...
		if( $value < $field['custom_minimum_setting'] )
		{
			$valid = __('The value is too little!','acf-buddypress_groups'),
		}
